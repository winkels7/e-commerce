  ...
  <div class="uk-container uk-width-1-1 uk-flex uk-margin-medium-top uk-margin-medium-bottom">
        <div class="uk-margin-medium-right">
                <ul class="uk-list uk-width-medium uk-background-primary uk-padding-small uk-border-rounded">
                    ...
                    <li><RouterLink to="/cookies" class="uk-button uk-button-text">Política de cookies</RouterLink></li>
                </ul>
      </div>
      <div>
    ...
    <p class="uk-text-lead">Cookies de Terceiros</p>
    ...
    <p class="uk-text-lead">Compromisso do Usuário</p>
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Parque das Palmeiras oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ul>
      <li>A) Não se envolver em atividades que sejam ilegais ou contrárias à boa fé a à ordem pública;</li>
      <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, generador de avisos de privacidad ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos humanos;</li>
      <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Parque das Palmeiras, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ul>

    <p class="uk-text-lead">Mais informações</p>
